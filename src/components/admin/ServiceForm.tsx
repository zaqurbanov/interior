      ...
      <div className="space-y-6 lg:col-span-2">
        ...
        <Card title="Image">
          {service?.image && (
            ...
            <img src={service.image} alt="" className="aspect-[21/9] w-full rounded object-cover" />
          )}
          <input type="file" name="imageFile" accept="image/jpeg,image/png,image/webp,image/avif" className="text-sm" />
        </Card>
        <Card title="SEO">

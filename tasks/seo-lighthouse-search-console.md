...
- [x] Vercel → Environment Variables → `NEXT_PUBLIC_SITE_URL=https://vladimir-fasij.com` (Production) → Redeploy (sitemap, canonical, paylaşım linkləri, e-poçtlar bu ünvandan qurulur)
- [x] (2026-09-26, sitemap oxundu) Google Search Console: **Domain** property `vladimir-fasij.com` (GoDaddy-də TXT yazısı ilə təsdiq) → Sitemaps → `https://vladimir-fasij.com/sitemap.xml`

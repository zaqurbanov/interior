# Admin panelin real (bazalı) yoxlanması
...
- [ ] Layihəyə bir neçə şəkil yükləmək → Save → saytda görünmək (Blob)
- [ ] Media: alt mətni yazıb saxlamaq → layihə səhifəsində `alt` olaraq görünmək
- [ ] Media: istifadə olunmayan şəkli silmək
- [ ] Qalereyada sıralama və ⭐ seçilmiş şəkillər → layihə səhifəsində
- [ ] Layihələr siyahısında sıralamanın saxlanması → saytdakı sıra
